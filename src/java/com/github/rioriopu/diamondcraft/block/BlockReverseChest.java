...
public class BlockReverseChest extends BlockChest{

	private final Random field_149955_b = new Random();

	protected BlockReverseChest(final int chest){
		super(chest);
	}
	...
	{
		final Block block = p_149689_1_.getBlock(p_149689_2_, p_149689_3_, p_149689_4_ - 1);
		final Block block1 = p_149689_1_.getBlock(p_149689_2_, p_149689_3_, p_149689_4_ + 1);
		final Block block2 = p_149689_1_.getBlock(p_149689_2_ - 1, p_149689_3_, p_149689_4_);
		final Block block3 = p_149689_1_.getBlock(p_149689_2_ + 1, p_149689_3_, p_149689_4_);
		byte b0 = 0;
		final int l = MathHelper.floor_double(p_149689_5_.rotationYaw * 4.0F / 360.0F + 0.5D) & 3;
		...
		{
			((TileEntityReverseChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
		}
	}
	...
	public void onNeighborBlockChange(final World p_149695_1_, final int p_149695_2_, final int p_149695_3_, final int p_149695_4_, final Block p_149695_5_)
	{
		...
		final TileEntityChest tileentitychest = (TileEntityReverseChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
	...
	{
		final TileEntityReverseChest  tileentitychest = (TileEntityReverseChest )p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
		...
		if (tileentitychest != null)
		{
			for (int i1 = 0; i1 < tileentitychest.getSizeInventory(); ++i1)
			{
				...
				if (itemstack != null)
				{
					final float f = this.field_149955_b.nextFloat() * 0.8F + 0.1F;
					final float f1 = this.field_149955_b.nextFloat() * 0.8F + 0.1F;
					EntityItem entityitem;

					for (final float f2 = this.field_149955_b.nextFloat() * 0.8F + 0.1F; itemstack.stackSize > 0; p_149749_1_.spawnEntityInWorld(entityitem))
					{
	...
	public IInventory func_149951_m(final World p_149951_1_, final int p_149951_2_, final int p_149951_3_, final int p_149951_4_)
	{
		...
		else
		{
			...
			{
				object = new InventoryLargeChest("Large Sapphire Chest", (TileEntityReverseChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
			}

			if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
			{
				object = new InventoryLargeChest("Large Sapphire Chest", (IInventory)object, (TileEntityReverseChest )p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
			}

			if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
			{
				object = new InventoryLargeChest("Large Sapphire Chest", (TileEntityReverseChest )p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
			}

			if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
			{
				object = new InventoryLargeChest("Large Sapphire Chest", (IInventory)object, (TileEntityReverseChest )p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
			}
	...
	{
		final TileEntityReverseChest  tileentitychest = new TileEntityReverseChest ();
	...
	{
		this.blockIcon = p_149651_1_.registerIcon(Reference.MODID + ":ReverseChest");
	}
