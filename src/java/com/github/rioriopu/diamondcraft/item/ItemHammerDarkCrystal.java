...
public class ItemHammerDarkCrystal extends Item
{
    private boolean repair = false;
    public ItemHammerDarkCrystal()
    {
        super();
        String DarkCrystalHammer = "DarkCrystalHammer";
        this.setUnlocalizedName(DarkCrystalHammer);
        this.setMaxStackSize(1);
        this.setMaxDamage(800); //効果がわかりやすいように数値を低く設定
    }
